        ...
        <section style={{ background: "#0d0d10", padding: "48px 24px", borderTop: "1px solid #1f1f28" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
              ...
              <Link href="/events/sea-and-vines-transfers" style={{ background: "#17171A", border: "1px solid #2A2A30", color: "#9CA3AF", padding: "8px 16px", borderRadius: 8, fontSize: 13, textDecoration: "none" }}>Sea & Vines Festival Transfers →</Link>
              <Link href="/occasions/hens-night" style={{ background: "#17171A", border: "1px solid #2A2A30", color: "#9CA3AF", padding: "8px 16px", borderRadius: 8, fontSize: 13, textDecoration: "none" }}>Hens Night Chauffeur →</Link>
            </div>
          </div>
        </section>
      </main>
